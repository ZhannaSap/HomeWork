...
import com.example.homework.databinding.FragmentAuthBinding
import com.example.homework.utils.AUTH_TYPES
...
class AuthFragment : Fragment() {
    ...
    private fun setupGoogleSignIn() {
        gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            .requestIdToken("650414322527-ijhc28ojv3f02ft8sgithmeq8v5u81b3.apps.googleusercontent.com")
            .requestEmail()
            .build()
